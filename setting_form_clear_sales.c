/** @file    setting_form_clear_sales.c
  * @author  
  * @version 
 ...
 */
bool SettingClearSales_KeyPress(uint8_t keyCode)
{
    ...
    else if (keyCode == '*')       /* ENTER KEY */
    {
      ...
      Resource_ClearSaleDay();
      Resource_ClearSaleYear();
